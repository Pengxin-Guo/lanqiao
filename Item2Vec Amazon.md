# Item2Vec AmazonBooks

A notebook to benchmark Item2Vec on AmazonBooks dataset.
...
```shell
Namespace(batch_size=4096, dataset='AmazonBooks', emb_dim=64, epochs=200, n_negs=20, topk='[20, 50]', window=20)
building vocab...
build done
